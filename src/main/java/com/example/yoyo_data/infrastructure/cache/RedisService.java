...
public interface RedisService {
     ...
     * @return JSON转换后的对象
     */
    <T> T hashGetJson(String hKey, String hashKey, Class<T> valueCls);
     ...
     * @return JSON转换后的对象
     */
    <T> List<T> hashGetList(String hKey, String hashKey, Class<T> valueCls);
     ...
     * @return JSON转换后的对象
     */
    Map<Object, Object> hashGetMap(String hKey, String hashKey);
     ...
     * @param expireSeconds 过期时间(毫秒)
     */
    void objectSetObject(String key, Object o, Long expireSeconds);
